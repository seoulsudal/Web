...
<script type="text/javascript" src="/personal/js/membershippage.js"></script>
</head>
<body>
	<p><font size="5">회원가입</font></p>
	<br>
	<form name="regform" method="post" onsubmit="return CheckForm(document.regform);" action="/personal/template2/memberShipTT">
